    ...
    <body>
      ...
      <form class="mood_form" action="form-process.php" method="POST">
        ...
        <div class="partOfFormCheck">
          <input type="checkbox" class="symptom" name="symptom[]" value="1">
          <label for="alt_tensionBack">Spänd rygg och nacke</label>
          <br>
          <input type="checkbox" class="symptom" name="symptom[]" value="2">
          <label for="alt_stomachAche">Ont i magen</label>
          <br>
          <input type="checkbox" class="symptom" name="symptom[]" value="3">
          <label for="alt_hyperventilation">Hyperventilering</label>
          <br>
          <input type="checkbox" class="symptom" name="symptom[]" value="4">
          <label for="alt_chestPain">Bröstsmärtor</label>
          <br>
          <input type="checkbox" class="symptom" name="symptom[]" value="5">
          <label for="alt_stomach">Orolig mage/Illamående</label>
          <br>
          <input type="checkbox" class="symptom" name="symptom[]" value="6">
          <label for="alt_dizzy">Yr/Svimfärdig</label>
          <br>
          <input type="checkbox" class="symptom" name="symptom[]" value="7">
          <label for="alt_heartRacing">Hjärtklappning</label>
          <br>
          <input type="checkbox" class="symptom" name="symptom[]" value="8">
          <label for="alt_coldSweat">Kallsvettningar</label>
          <br>
          <input type="checkbox" class="symptom" name="symptom[]" value="9">
          <label for="alt_concentration">Koncentrationssvårigheter</label>
          <br>
          <input type="checkbox" class="symptom" name="symptom[]" value="10">
        ...
        <div id="comment">
          ...
          <br>
          <textarea name="commentSection" id="commentSection" placeholder="Skriv en kommentar"></textarea>
        </div>
